                    ...
                    <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3 p-5">
                            ...
                            <div class="row invoice-info">
                                <div class="col-sm-4 invoice-col">
                                    <address>
                                        ...
                                        Nome: <?php echo $value['nome_cliente'] . " " . $value['sobrenome']; ?><br>
                            ...
                            <div class="row invoice-info">
                                <div class="col-sm-4 invoice-col">
                                    <address>
                                        <strong>Laudo do Técnico.</strong><br>
                                        <b>Tipo Serviço:</b> <?php echo $value['tipo_servico']; ?><br>
                                ...
                                <div class="col-sm-4 invoice-col">
                                    <address>
                                        <strong></strong><br>
                                        <b> Valor De Serviço: </b><?php echo number_format($value['valor'], 2, ",", "."); ?> Kz
                                    </address>
                                </div>
                                <!-- /.col -->
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo number_format($value['valor'], 2, ",", ".") ?> Kz</td>
                                            </tr>
                                            <tr>
                                                <th>Desconto
                                                    <?php
                                                    $value['valortotali'] = $value['valor'] + $totalproduto;
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    <a href="<?php echo URLADM . "relatorioTecnico?relatorio=imprimirorcamento&idorcamentos=" . $valorForm['idorcamentos']; ?>" rel="noopener" target="_blank" class="btn btn-default border"><i class="fas fa-print"></i> Print</a>
